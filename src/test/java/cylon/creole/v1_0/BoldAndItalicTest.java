 ...
 */
public abstract class BoldAndItalicTest extends DomBuilder {
    protected CreoleParser dut;

    public static class AdhocParserTest extends BoldAndItalicTest {
        @Before
    ...
    public static class LineParserTest extends BoldAndItalicTest {
        @Before
        public void beforeEach() {
