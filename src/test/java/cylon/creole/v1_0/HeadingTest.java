 ...
 */
public abstract class HeadingTest extends DomBuilder {
    protected CreoleParser dut;

    public static class AdhocParserTest extends HeadingTest {
        @Before
    ...
    public static class LineParserTest extends HeadingTest {
        @Before
        public void beforeEach() {
